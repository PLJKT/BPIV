...
window.BPIV_I18N = {
  en: {
    ...
    company: {
      ...
      bpivExpSub: "Per group ledger 'c. Biaya Opex' rows (2013\u20132025); 2026* = Jan\u2013Jul YTD per Jul-2026 monthly report (mapped to ledger categories). Write-off and forex are non-operating items.",
  ...
  zh: {
    ...
    company: {
      ...
      bpivExpSub: "按集团台账“c. Biaya Opex”行（2013–2025）；2026* 为 1–7 月累计（按 2026-07 月报映射至台账类别）。核销与汇兑为非运营项目。",
      expSalary: "工资与津贴",
      expRent: "租金与服务费",
      expAdm: "行政管理费",
  ...
  id: {
    ...
    company: {
      ...
      bpivExpSub: "Per baris 'c. Biaya Opex' buku besar grup (2013\u20132025); 2026* = Jan\u2013Jul YTD per laporan bulanan Jul-2026 (dipetakan ke kategori buku besar). Penghapusbukuan dan selisih kurs adalah pos non-operasional.",
